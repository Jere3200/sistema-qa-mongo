...
import { Loader2, ArrowLeft, BookOpen, GitCompare, FlaskConical, Mail } from 'lucide-react'
      ...
      <div className="hidden lg:flex flex-col items-center justify-center bg-teal-600 p-12">
        ...
        >
          ...
          <p className="text-teal-100 leading-relaxed text-sm">
            Te enviamos un enlace seguro para restablecer tu contraseña. Revisá tu bandeja de entrada.
          </p>
        ...
        >
          ...
          {enviado ? (
            <div className="bg-white rounded-2xl border border-teal-200 shadow-sm p-8 text-center">
              ...
              <p className="text-sm text-gray-500 mb-1">Enviamos un enlace de recuperación a</p>
              <p className="text-sm font-semibold text-gray-900 mb-5">{form.getValues('email')}</p>
